"""
Django settings for fitai_40108 project.
...
WSGI_APPLICATION = 'fitai_40108.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fitai_40108 API",
    "DESCRIPTION": "API documentation for fitai_40108 App",
    "VERSION": "v1",
}
